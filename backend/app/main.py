...
async def redirect_short_link(
    ...
    # FB / Zalo in-app browser + TikTok/Shopee → landing page thay vì redirect thẳng.
    # Redirect thẳng → TikTok web auto-trigger mở app → FB hiện popup ngay lập tức.
    # Landing page → user chủ động bấm nút, trải nghiệm rõ ràng hơn.
